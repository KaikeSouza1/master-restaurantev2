...
import { CreatePedidoDto, AbrirMesaDto, AdicionarItensDto, TransferirMesaDto, AtualizarStatusDto, JuntarMesasDto, FinalizarCaixaDto } from './dto/restaurante.dtos';
...
export declare class RestauranteController {
    ...
    finalizarMesaCaixa(codseq: number, dto: FinalizarCaixaDto, req: Request): Promise<{
        obs: string | null;
        tipo: string | null;
        nome_cli_esp: string | null;
        fone_esp: string | null;
    ...
    removerItemMesa(codseq: number, codseqItem: number, motivo?: string): Promise<{
        obs: string | null;
        tipo: string | null;
        nome_cli_esp: string | null;
        fone_esp: string | null;
    ...
    editarQuantidadeItem(codseq: number, codseqItem: number, body: {
    ...
    calcularDivisao(codseq: number, body: {
        num_pessoas: number;
        itens_por_pessoa: Array<{
            codseq_item: number;
            pessoa: number;
        }>;
    }): Promise<{
    ...
    registrarPagamentoParcial(codseq: number, body: {
